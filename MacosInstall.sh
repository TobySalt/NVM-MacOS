...
function installNoMAD {
  ...
  # Set the AD Domain
  defaults write $nomadConf ADDomain -string "general.newvoicemedia.com"
  # Set 'Get help' menu item to open an email to itcase@newvoicemedia.com
  defaults write $nomadConf GetHelpType -string 'URL'
  defaults write $nomadConf GetHelpOptions -string 'mailto:itcase@newvoicemedia.com'
